...
module.exports = async (deployer, network, [defaultAccount]) => {
    ...
    if (network.startsWith('rinkeby')) {
        await deployer.deploy(Booking, RINKEBY_VRF_COORDINATOR, RINKEBY_LINKTOKEN, RINKEBY_KEYHASH)
        let myt = await Booking.deployed()
      ...
      //   console.log("If you're interested in early access to Chainlink VRF on mainnet, please email vrf@chain.link")
        ...
        // await deployer.deploy(Booking)
        // let dnd = await Booking.deployed()
      }
